...
export class ApiKeysController {
  ...
  @ApiOperation({
    ...
    description:
      "Creates a new API key with specified configuration for the authenticated user",
  })
  @ApiResponse({
  ...
  @ApiOperation({
    ...
    description:
      "Retrieves the history of all API keys for the authenticated user",
  })
  @ApiResponse({
  ...
  async getApiKeyHistory(
    ...
    try {
      ...
      this.logger.log(
        `API key history retrieved for user ${userId}: ${history.total} keys`,
      );
  ...
  async revokeApiKey(
    ...
    try {
      ...
      this.logger.log(
        `API key ${keyId} revoked successfully for user ${userId}`,
      );
  ...
  @ApiOperation({
    ...
    description:
      "Returns upload constraints (file size limits, allowed types, etc.) for a given public API key",
  })
  @ApiResponse({
    status: HttpStatus.OK,
  ...
  ): Promise<ConstraintsResponseDto> {
    try {
