...
interface MediaLibraryAppLayoutProps {
  children: ReactNode;
}

export function MediaLibraryAppLayout({ children }: MediaLibraryAppLayoutProps) {
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex-1 overflow-hidden">
          <Card className="h-full m-6 border-0 shadow-sm">
            {children}
          </Card>
        </div>
      </div>
